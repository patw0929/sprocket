...
Environment = (function(superclass){
  ...
  function Environment(){
    ...
    this._minify_html = false;
    this._minify_js = false;
    this._minify_css = false;
    this._use_manifest = false;
    this._base_paths = [];
  }
  ...
  Object.defineProperty(prototype, 'minifyHTML', {
    get: function(){
      return this._minify_html;
    },
    set: function(value) {
      this._minify_html = !!value;
    },
    configurable: true,
    enumerable: true
  });
  Object.defineProperty(prototype, 'minifyJS', {
    get: function(){
      return this._minify_js;
    },
    set: function(value) {
      this._minify_js = !!value;
    },
    configurable: true,
    enumerable: true
  });
  Object.defineProperty(prototype, 'minifyCSS', {
    get: function(){
      return this._minify_css;
    },
    set: function(value) {
      this._minify_css = !!value;
    },
    configurable: true,
    enumerable: true
  });
  Object.defineProperty(prototype, 'useManifest', {
    get: function(){
      return this._use_manifest;
    },
    set: function(value) {
      this._use_manifest = !!value;
    },
    configurable: true,
    enumerable: true
  });
